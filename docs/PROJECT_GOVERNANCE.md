...
The Wayfarer is not only a software project or an interactive experience.

It is a long-term exploration of:
...
Principles without growth may lose vitality.
...
The founder's role is not only ownership.
...
Commercial activities should support the project.
...
Future successors and maintainers should understand that their responsibility is not simply to manage a project.

Their responsibility is to continue a long-term exploration.

Any future succession mechanism should prioritize:
...
A successor may guide evolution.
...
Financial contribution does not automatically create authority over the project's foundational direction.

Commercial success should serve the mission.
...
At the same time, contributors are responsible for ensuring that their submissions:

- respect applicable laws;
- do not violate third-party rights;
- are submitted with appropriate authorization.
...
Conflicts should be addressed through:
...
However, the purpose of exploration should continue.

The Wayfarer is not merely a project to be managed.
